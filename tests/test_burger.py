...
def test_add_ingredient(ingredients_list, expected_value):
    burger = Burger()
...
def test_remove_ingredients(
        burger_with_three_ingredients, ingredient_index,
...
def test_remove_all_ingredients(burger_with_three_ingredients):
...
def test_move_ingredient(burger_with_three_ingredients, mock_ingredient_1, mock_ingredient_2):
...
def test_get_price(burger_with_three_ingredients, mock_burger):
...
def test_get_receipt(burger_with_three_ingredients, mock_burger):
    print(burger_with_three_ingredients.get_receipt())
